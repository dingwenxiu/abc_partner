...
@Component({
  selector: 'app-view-withdraw-list',
  templateUrl: './view-withdraw-list.component.html',
  styleUrls: ['./view-withdraw-list.component.scss']
})

export class FinanceViewWithdrawListComponent implements OnInit, OnDestroy {
  ...
  public async subHank() {
    ...
    if (!this.handPop.data['reason'] || !/\S/.test(`${this.handPop.data['reason']}`)) {
