...
@Component({
  ...
  styleUrls: ['./partner-visit.component.scss']
})

export class BackupPartnerVisitComponent implements OnInit {
  public tableList = [];
  public dateRange = [];
  public page = {
    index: 1,
  ...
  public async getDataList() {
    ...
    const response = await this.api.Http({ name: 'partnerVisit', data: { ...this.searchData } });
