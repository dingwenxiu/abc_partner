...
@Component({
  selector: 'app-player-commission',
  templateUrl: './player-commission.component.html',
  styleUrls: ['./player-commission.component.scss']
})

export class BackupPlayerCommissionComponent implements OnInit {
  public tableList  = [];
  public dateRange  = [];
  public page = {
    index: 1,
