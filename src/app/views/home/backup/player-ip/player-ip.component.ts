...
@Component({
  selector: 'app-player-ip',
  templateUrl: './player-ip.component.html',
  styleUrls: ['./player-ip.component.scss']
})

export class BackupPlayerIpComponent implements OnInit {
  public tableList  = [];
  public dateRange  = [];
  public page = {
    index: 1,
  ...
  public async getDataList() {
    ...
    const response = await this.api.Http({name: 'playerIp', data: {...this.searchData}});
