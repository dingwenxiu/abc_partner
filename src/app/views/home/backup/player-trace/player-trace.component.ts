...
@Component({
  selector: 'app-player-trace',
  templateUrl: './player-trace.component.html',
  styleUrls: ['./player-trace.component.scss']
})

export class BackupPlayerTraceComponent implements OnInit {
  public tableList = [];
  public dateRange = [];
  public page = {
    index: 1,
  ...
  public async getDataList() {
    ...
    const response = await this.api.Http({ name: 'playerTrace', data: { ...this.searchData } });
