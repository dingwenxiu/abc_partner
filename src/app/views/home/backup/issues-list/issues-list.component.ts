...
export class BackupIssuesListComponent implements OnInit {
  public tableList  = [];
  public dateRange  = [];
  public page = {
    index: 1,
  ...
  public search() {
    ...
    console.log(this.searchData['start_time'], nowMonth);
    this.getDataList();
  }
  ...
  public async getDataList() {
    ...
    const response = await this.api.Http({name: 'issuesList', data: {...this.searchData}});
